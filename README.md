...
В качестве платформы для тестирования системы использовалась виртуальная машина "Almalinux 8.6 x86_64", развернутая в системе виртуализации ESXi 6.5.
...
**frontend/limits.d/nginx.conf** - параметры ограничений максимального количества потоков пользователя nginx
